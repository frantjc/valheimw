...
set "FILES_TO_REMOVE=%FILES_TO_REMOVE% %VALHEIM_DIR%__README_NAME__"
set "FILES_TO_REMOVE=%FILES_TO_REMOVE% %VALHEIM_DIR%__UNINSTALL_SINDRI_SH_NAME__"
set "FILES_TO_REMOVE=%FILES_TO_REMOVE% %VALHEIM_DIR%__UPDATE_SINDRI_SH_NAME__"
set "FILES_TO_REMOVE=%FILES_TO_REMOVE% %VALHEIM_DIR%__UPDATE_SINDRI_CMD_NAME__"
...
del "%VALHEIM_DIR%__UNINSTALL_SINDRI_CMD_NAME__" 2>nul
