...
curl -fSs "%PROTOCOL%://%HOST%/mods.gz" | tar -xzf -
if %ERRORLEVEL% neq 0 (
    echo Failed to download new Sindir files.
    exit /b 1
)
...
set `FILES_TO_CLEANUP=%FILES_TO_CLEANUP% "%VALHEIM_DIR%__UNINSTALL_SH_NAME__"`
set `FILES_TO_CLEANUP=%FILES_TO_CLEANUP% "%VALHEIM_DIR%__UPDATE_SH_NAME__"`
